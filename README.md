...
De Specificatie van de betreffende API's zijn op de volgende locaties te bekijken :
 - Aanslagregels-API in [Swagger-UI](https://github.com/VNG-Realisatie/IMWOZ-bevragingen/main/docs/ASL-swagger-ui) of [Redoc](https://github.com/VNG-Realisatie/IMWOZ-bevragingen/main/docs/ASL-redoc) --- [technische specificaties](specificatie/ASL/openapi.yaml)
 - Biljetten-API in [Swagger-UI](https://github.com/VNG-Realisatie/IMWOZ-bevragingen/main/docs/BLJ-swagger-ui) of [Redoc](https://github.com/VNG-Realisatie/IMWOZ-bevragingen/main/docs/BLJ-redoc) --- [technische specificaties](specificatie/BLJ/openapi.yaml)
